...
<div class="row justify-content-center">
    <div class="col-md-6">
        ...
        @endif
        <h1>Internship</h1>
        <p>Saat ini saya baru lulus dari pendidikan formal terakhir dan ingin mengenal dunia kerja</p>
        <form action="{{ route('register.action') }}" method="POST">
			...
			<div class="form-check">
  				<input class="form-check-input" type="checkbox" name="status" value="internship">
